...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public final static String EXTRA_MESSAGE = "com.example.taneea.assignment3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mInteractWithDBButton = (Button) findViewById(R.id.interact_with_db_button);

        mInteractWithDBButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                interactWithDB();
            }
    ...
    private void attemptLogin() {
        ...
        String email_prev = pref.getString("username", "");
        String password_prev = pref.getString("password", "");
        
        if ((email_prev.equals(email)) && (password_prev.equals(password))) {
            Log.d(TAG,"Condition 1");
            Toast.makeText(LoginActivity.this, "Your login details remain same", Toast.LENGTH_SHORT).show();
        }
        else if ((email_prev.equals(email)) && (!password_prev.equals(password))) {
            ...
            // Commit the changes
            edit.commit();
            Toast.makeText(LoginActivity.this, "Your password was updated", Toast.LENGTH_SHORT).show();
        }
        else if ((!email_prev.equals(email)) && (password_prev.equals(password))) {
            ...
            // Commit the changes
            edit.commit();
            Toast.makeText(LoginActivity.this, "Your username was updated", Toast.LENGTH_SHORT).show();
        }
            ...
            // Commit the changes
            edit.commit();
            Toast.makeText(LoginActivity.this, "Your email and password were updated", Toast.LENGTH_SHORT).show();
        }

        String FILENAME = "internal_file";
        FileOutputStream pwd_private = null;
        try {
            pwd_private = openFileOutput(FILENAME, Context.MODE_PRIVATE);
            pwd_private.write(password.getBytes());
            pwd_private.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
